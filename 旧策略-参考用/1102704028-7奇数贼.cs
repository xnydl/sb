...
namespace SmartBotProfiles
{
    ...
    public class WildDemonHunter : Profile
    {
        ...
        public ProfileParameters GetParameters(Board board)
        {
            ...
            {
                p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.HERO_03bp, new Modifier(-60)); //武器优先级=-60
            }
            ...
            int ClanThugCount = board.Hand.Count(card => card.Template.Id == Card.Cards.GIL_534);//荆棘帮暴徒 Hench-Clan Thug
