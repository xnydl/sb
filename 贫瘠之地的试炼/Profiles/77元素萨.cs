...
#region  随从优先级
    ...
    p.CastMinionsModifiers.AddOrUpdate(Card.Cards.SW_033, new Modifier(150));//运河慢步者 Canal Slogger ID：SW_033 
    p.CastMinionsModifiers.AddOrUpdate(Card.Cards.SW_032, new Modifier(-99));//花岗岩熔铸体 SW_032 
...
#region 法术优先级
    ...
    p.CastSpellsModifiers.AddOrUpdate(Card.Cards.AV_259 , new Modifier(130));//冰霜撕咬 Frostbite ID：AV_259 
    p.CastSpellsModifiers.AddOrUpdate(Card.Cards.AV_268 , new Modifier(-99));//蛮爪洞穴 AV_268
...
//德：DRUID 猎：HUNTER 法：MAGE 骑：PALADIN 牧：PRIEST 贼：ROGUE 萨：SHAMAN 术：WARLOCK 战：WARRIOR 瞎：DEMONHUNTER
        ...
        //卡扎库斯选择
        public Card.Cards BrukanOfTheElementsChoice(List<Card.Cards> choices)
        {
            return choices[0];
        }
