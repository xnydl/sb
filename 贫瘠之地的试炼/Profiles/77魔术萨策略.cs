...
#region 笔记能手 SCH_236
      if(board.HasCardInHand(Card.Cards.SCH_236)
      ){
        p.PlayOrderModifiers.AddOrUpdate(Card.Cards.SCH_236, new Modifier(9999));
          Bot.Log("笔记能手优先级9999");
      }
#endregion
...
#region 风暴召唤者布鲁坎 SW_031t7 
          if(board.HasCardInHand(Card.Cards.SW_031t7)
            ){
