...
#region 攻击模式和自定义 
 ...
 // 海盗数量
            ...
            // 手上暗影法术数量 亡者复生 SCH_514 暗中生长 CS3_028 虚空碎片 SW_442
            int NumberShadow=board.Hand.Count(x => x.Template.Id == Card.Cards.SCH_514)+board.Hand.Count(x => x.Template.Id == Card.Cards.CS3_028)+board.Hand.Count(x => x.Template.Id == Card.Cards.SW_442);
            Bot.Log("手上暗影法术数量"+NumberShadow);
 #endregion
