...
#endregion
#region 圣物仓库 REV_942
       if(board.HasCardInHand(Card.Cards.REV_942)
       ){
        p.LocationsModifiers.AddOrUpdate(Card.Cards.REV_942, new Modifier(-999));
        Bot.Log("圣物仓库 -999");
      }
#endregion
#region 幻灭心能圣物 REV_943
       if(board.HasCardInHand(Card.Cards.REV_943)
       ){
        p.CastSpellsModifiers.AddOrUpdate(Card.Cards.REV_943, new Modifier(-99));
        Bot.Log("幻灭心能圣物 -99");
      }
#endregion
#region 圣物仓库 REV_942
       if(board.HasCardInHand(Card.Cards.REV_942)
        ...
        p.CastSpellsModifiers.AddOrUpdate(Card.Cards.REV_942, new Modifier(-99));
        Bot.Log("圣物仓库 -99");
      }
#endregion
#region 布莱恩·铜须 Brann Bronzebeard ID：CORE_LOE_077 
            ...
            if(board.HasCardInHand(Card.Cards.CORE_LOE_077)
            &&board.HasCardInHand(Card.Cards.REV_021)
            &&board.HasCardInHand(Card.Cards.REV_906t)
            &&board.ManaAvailable >= 9
            ){
       	    p.CastMinionsModifiers.AddOrUpdate(Card.Cards.CORE_LOE_077, new Modifier(-99)); 
       	    p.CastMinionsModifiers.AddOrUpdate(Card.Cards.REV_021, new Modifier(-99)); 
       	    p.CastMinionsModifiers.AddOrUpdate(Card.Cards.REV_906t, new Modifier(-99)); 
            p.PlayOrderModifiers.AddOrUpdate(Card.Cards.CORE_LOE_077, new Modifier(999));
            p.PlayOrderModifiers.AddOrUpdate(Card.Cards.REV_021, new Modifier(999));
            p.PlayOrderModifiers.AddOrUpdate(Card.Cards.REV_906t, new Modifier(999));
            Bot.Log("打combe");
            }    
#endregion
...
#endregion
#region 杰斯·织暗 Jace Darkweaver ID：SW_044 
       if(board.HasCardInHand(Card.Cards.SW_044)){
       	p.CastMinionsModifiers.AddOrUpdate(Card.Cards.SW_044, new Modifier(150));
        p.PlayOrderModifiers.AddOrUpdate(Card.Cards.SW_044, new Modifier(10));
        Bot.Log("杰斯·织暗 150");
      }
#endregion
#region GAME_005
...
#region 剃刀野猪 BAR_325
      ...
      &&wangyunum>0
        ...
        p.OnBoardFriendlyMinionsValuesModifiers.AddOrUpdate(Card.Cards.BAR_325, new Modifier(-150)); 
        Bot.Log("剃刀野猪送");
      }
#endregion
...
#region 剃刀沼泽兽王 BAR_326
      ...
      &&wangyunum>0
        ...
        p.OnBoardFriendlyMinionsValuesModifiers.AddOrUpdate(Card.Cards.BAR_326, new Modifier(-150)); 
        Bot.Log("剃刀沼泽兽王送");
      }
#endregion
#region 锈烂蝰蛇 SW_072
      ...
      &&board.WeaponEnemy != null
        ...
        p.CastMinionsModifiers.AddOrUpdate(Card.Cards.SW_072, new Modifier(-99));
        Bot.Log("锈烂蝰蛇-99");
      }
#endregion
...
#endregion
#region 历战先锋 AV_118  
            if(board.Hand.Exists(x=>x.CurrentCost==2 && x.Template.Id==Card.Cards.AV_118)
            &&board.WeaponFriend == null
            &&board.MaxMana ==2
...
#region 化石狂热者 Fossil Fanatic ID：TID_704
            if(board.Hand.Exists(x=>x.CurrentCost==2 && x.Template.Id==Card.Cards.TID_704)
            &&board.WeaponFriend == null
            &&board.MaxMana <3
            ){
...
#endregion
#region 混乱使徒 Herald of Chaos ID：TID_706 
            if(board.HasCardInHand(Card.Cards.TID_706)
            ){
            p.CastMinionsModifiers.AddOrUpdate(Card.Cards.TID_706, new Modifier(130)); 
            Bot.Log("混乱使徒 130");
            }
#endregion
#region 召唤咒符 WC_003
...
//             ){
//             p.CastSpellsModifiers.AddOrUpdate(Card.Cards.BAR_891, new Modifier(250)); 
//             Bot.Log("怒火（等级1）250");
//             }
// #endregion
...
//             ){
//             p.CastSpellsModifiers.AddOrUpdate(Card.Cards.BAR_891t, new Modifier(250)); 
//             Bot.Log("怒火（等级2）250");
//             }
// #endregion
...
//             ){
//             p.CastSpellsModifiers.AddOrUpdate(Card.Cards.BAR_891t2, new Modifier(250)); 
//             Bot.Log("怒火（等级3）250");
//             }
// #endregion
#region 捕掠 TSC_058
