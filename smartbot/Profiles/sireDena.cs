...
namespace SmartBotProfiles
{
    ...
    public class PlayOrderPriority : Profile
    {
		...
		public ProfileParameters GetParameters(Board board)
        {
           ...
           /* var flameImpId = board.Hand.First(x => x.Template.Id == Card.Cards.CORE_EX1_319);
            var voidWalkerId = board.Hand.First(x => x.Template.Id == Card.Cards.CORE_CS2_065);
            var theCoin = board.Hand.First(x => x.Template.Id == Card.Cards.GAME_005);
            var vileLib = board.Hand.First(x => x.Template.Id == Card.Cards.REV_371);
...
*/
            ...
            if(SireDenathriusCard != null)
            {
				...
				Bot.Log("Sire Dena damages : " + sireDenaDamages.ToString());
            }
