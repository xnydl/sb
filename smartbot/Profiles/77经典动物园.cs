...
#endregion
#region 飞刀杂耍者 VAN_NEW1_019
            if(board.HasCardInHand(Card.Cards.VAN_NEW1_019)
            ){
          p.PlayOrderModifiers.AddOrUpdate(Card.Cards.VAN_NEW1_019, new Modifier(999));
            }
#endregion
#region 年轻的女祭司 VAN_EX1_004 
...
#region 生命分流 Life Tap   HERO_07bp 
 p.CastMinionsModifiers.AddOrUpdate(Card.Cards.SCH_312, new Modifier(-99));//巡游向导 Tour Guide     SCH_312
        p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.HERO_07bp, new Modifier(75));//生命分流 Life Tap ID：HERO_07bp
