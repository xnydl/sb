...
#region 攻击模式和自定义 
 ...
 #endregion
 #region 狂暴利齿 Frenzied Fangs ID：REV_350  
       if(board.HasCardInHand(Card.Cards.REV_350)){
       	p.CastSpellsModifiers.AddOrUpdate(Card.Cards.REV_350, new Modifier(250)); 
        Bot.Log("狂暴利齿 250");
      }
#endregion
#region 狂暴利齿 Frenzied Fangs ID：REV_350t2
       if(board.HasCardInHand(Card.Cards.REV_350t2)){
       	p.CastSpellsModifiers.AddOrUpdate(Card.Cards.REV_350t2, new Modifier(-99)); 
        Bot.Log("狂暴利齿+ -99");
      }
#endregion
 #region 深铁穴居人  AV_137  
...
#endregion
#region 野性之魂 REV_361 
       if(board.HasCardInHand(Card.Cards.REV_361)
        && board.MinionFriend.Count <=5
       ){
       	p.CastSpellsModifiers.AddOrUpdate(Card.Cards.REV_361, new Modifier(-99)); 
        Bot.Log("野性之魂 -99");
      }
#endregion
#region 生命分流 Life Tap   HERO_07bp
        if(board.Hand.Count<=9)
         {   p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.HERO_07bp, new Modifier(5));//生命分流 Life Tap ID：HERO_07bp
            p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.VAN_HERO_07bp, new Modifier(5));//生命分流 Life Tap ID：HERO_07bp
            p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.CS2_056_H1, new Modifier(5));//生命分流 Life Tap ID：HERO_07bp
            p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.CS2_056_H2, new Modifier(5));//生命分流 Life Tap ID：HERO_07bp
            p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.CS2_056_H3, new Modifier(5));//生命分流 Life Tap ID：HERO_07bp
            p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.HERO_07ebp, new Modifier(5));//生命分流 Life Tap ID：HERO_07bp
            p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.AV_316hp, new Modifier(5));//恐惧之链 Chains of Dread ID：AV_316hp 
        }
#endregion
