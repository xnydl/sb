      ...
      public ProfileParameters GetParameters(Board board)
      {
            ...
            }          
       {
         ...
         //定义场攻  用法 myAttack <= 5 自己场攻大于小于5  enemyAttack  <= 5 对面场攻大于小于5  已计算武器伤害
            ...
            int isflag=board.MinionFriend.Count(x => x.Template.Id == Card.Cards.SW_078)+board.Hand.Count(x => x.Template.Id == Card.Cards.SW_078)+board.FriendGraveyard.Count(card => CardTemplate.LoadFromId(card).Id == Card.Cards.SW_078);
