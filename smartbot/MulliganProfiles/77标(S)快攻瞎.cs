    ...
    public class DefaultMulliganProfile : MulliganProfile
    {
            ...
            Card.CClass ownClass)
        {
            ...
            foreach (Card.Cards card in choices)
            {
                ...
                if(card==Card.Cards.REV_509// 放大战刃 REV_509
                ){flag6+=1;}
            }
            ...
            foreach (Card.Cards card in choices)
            {
                if(card==Card.Cards.AV_137&&flag6>0// 深铁穴居人 AV_137
                ){
                ...
                if(card==Card.Cards.SW_451&&flag6>0// 魔变鱼人 Metamorfin ID：SW_451
                ){
                ...
                if(card==Card.Cards.CORE_BT_351&&flag6>0// 战斗邪犬 CORE_BT_351
                ){
                ...
                if(card==Card.Cards.SW_041&&flag6>0// 敏捷咒符 Sigil of Alacrity ID：SW_041 
                ){
                ...
                if(card==Card.Cards.AV_209&&flag6>0// 恐惧牢笼战刃 AV_209
                ){
                ...
                if(card==Card.Cards.TSC_006&&HasCoin==true&&flag6>0// 多重打击 Multi-Strike ID：TSC_006 
                ){
                    if(!CardsToKeep.Contains(Card.Cards.TSC_006))
                    {
                        Keep(card,"多重打击");
                ...
                if(card==Card.Cards.TSC_827&&flag6>0// 凶恶的滑矛纳迦 TSC_827
                ){
                ...
                //     } 
                // }
                if(card==Card.Cards.AV_118&&flag6>0// 历战先锋 AV_118
                ){
                ...
                if(card==Card.Cards.AV_100&&flag6>0// 德雷克塔尔 AV_100
                ){
                ...
                if(card==Card.Cards.BAR_721&&flag6>0// 曼科里克 Mankrik ID：BAR_721
                ){
                ...
                if(card==Card.Cards.TSC_217&&flag6>0// 游荡贤者 Wayward Sage ID：TSC_217 
                 ...
                 if(card==Card.Cards.WC_003&&flag6>0// 召唤咒符 WC_003 
                ){
                ...
                //     } 
                // }
                 if(card==Card.Cards.ONY_016&&flag6>0// 憎恨之翼（等级1） ONY_016
                ){
                 ...
                 if(card==Card.Cards.TID_704&&flag6>0// 化石狂热者 Fossil Fanatic ID：TID_704 
                ){
                 ...
                 if(card==Card.Cards.AV_267&&flag6>0// 凯丽娅·邪魂 Caria Felsoul ID：AV_267 
                ){
                 ...
                 if(card==Card.Cards.BT_035&&flag6>0// 混乱打击 Chaos Strike ID：BT_035
                ){
                 ...
                 if(card==Card.Cards.REV_511// 案卷书虫 REV_511 
                ){
                    if(!CardsToKeep.Contains(Card.Cards.REV_511))
                    {
                        Keep(card,"案卷书虫");
                    } 
                }
                 if(card==Card.Cards.REV_509// 放大战刃 REV_509
                    ...
                    if(!CardsToKeep.Contains(Card.Cards.REV_509))
                    {
                        Keep(card,"放大战刃");
                    } 
                }
