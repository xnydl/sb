...
// # 1x (7) 光铸凯瑞尔
// #
// AAECAZ8FCPvoA5HsA/P2A8f5A7eABL+ABOCLBOq4BAvKwQO/0QPM6wOm9QPw9gON+AO2gATJoAThpAT0pAT5pAQA
// # 想要使用这副套牌，请先复制到剪贴板，再在游戏中创建新套牌。
// # 套牌详情请查看https://hsreplay.net/decks/SfKp8cLMcEehNlN9DDpPb/
    ...
    public class DefaultMulliganProfile : MulliganProfile
    {
            ...
            Card.CClass ownClass)
        {
            ...
            foreach (Card.Cards card in choices)
            {
               ...
               if(!CardsToKeep.Contains(Card.Cards.BT_020))
                    {
                        Keep(card,"奥尔多侍从");
                    }
                }
                ...
                ){ if(!CardsToKeep.Contains(Card.Cards.SW_418))
                    {
                        Keep(card,"军情七处潜伏者");
                    }
                }
                ...
                ){ if(!CardsToKeep.Contains(Card.Cards.BT_025)&&flag1>=1)
                    {
                        Keep(card,"智慧圣契");
                    }
                }
