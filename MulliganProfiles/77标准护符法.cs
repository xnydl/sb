...
// # 1x (5) 泰兰·弗丁
// # 1x (5) 暗影猎手沃金
// # 1x (6) 巴琳达·斯通赫尔斯 AV_284
// # 1x (7) 魔导师晨拥
// # 1x (7) 克苏恩面具
// # 2x (10) 龙火护符
// #
// AAECAf0ECJXNA/vdA+DlA6CKBKiKBJ+SBMSgBP+iBAv4zAOk0QOL1QOW6AP46APT7APJ+QOTgQShkgThpAT6rAQA
// # 想要使用这副套牌，请先复制到剪贴板，再在游戏中创建新套牌。
// # 套牌详情请查看https://hsreplay.net/decks/MVGxtIfUqIYrjXvb8f1w6g/
    ...
    public class DefaultMulliganProfile : MulliganProfile
    {
            ...
            Card.CClass ownClass)
        {
            ...
            foreach (Card.Cards card in choices)
            {
                 ...
                 if((card==Card.Cards.SCH_350//魔杖窃贼 SCH_350
                )){
                     if(!CardsToKeep.Contains(Card.Cards.SCH_350))
                    {
                        Keep(card,"魔杖窃贼");
                    }
                }
                 if((card==Card.Cards.CORE_KAR_009//呓语魔典 CORE_KAR_009 
                )){
                     if(!CardsToKeep.Contains(Card.Cards.CORE_KAR_009))
                    {
                        Keep(card,"呓语魔典");
                    }
                }
