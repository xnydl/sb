...
// # 1x (10) 团本首领奥妮克希亚
// #
// AAECAa0GBsi+A7CKBLSKBMGfBKWtBISwBAyTugPezAPi3gP73wP44wOe6wOH9wOtigSKowS6rATIrATUrAQA
// # 想要使用这副套牌，请先复制到剪贴板，再在游戏中创建新套牌。
// # 套牌详情请查看https://hsreplay.net/decks/PW7UZjNitnA7PLf93suGGc/
    ...
    public class DefaultMulliganProfile : MulliganProfile
    {
            ...
            Card.CClass ownClass)
        {
            ...
            foreach (Card.Cards card in choices)
            {
                 ...
                 if((card==Card.Cards.BT_252//复苏 BT_252 
                )){
                    {
                       if(!CardsToKeep.Contains(Card.Cards.BT_252))
                    {
                        Keep(card,"复苏");
                    }
                    }   
                }
                 if((card==Card.Cards.ONY_017// 拉希奥的角 ONY_017 
                )){
                    {
                       if(!CardsToKeep.Contains(Card.Cards.ONY_017))
                    {
                        Keep(card,"拉希奥的角");
                    }
                    }   
