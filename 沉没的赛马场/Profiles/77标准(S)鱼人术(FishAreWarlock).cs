...
#region 直伤卡牌 标准模式
        ...
        private static readonly Dictionary<Card.Cards, int> _MinionDamagesTable = new Dictionary<Card.Cards, int>
        {
            ...
            {Card.Cards.DMF_254, 3},//迦顿男爵 Baron Geddon     CORE_EX1_249 
            {Card.Cards.TSC_219, 8},//渊狱魔犬希拉格 Xhilag of the Abyss ID：TSC_219 
        };
        #endregion
...
#region 鱼饵桶 TSC_957 
            ...
            p.PlayOrderModifiers.AddOrUpdate(Card.Cards.BAR_880, new Modifier(999));
