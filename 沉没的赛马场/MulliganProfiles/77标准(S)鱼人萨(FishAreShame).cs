    ...
    public class DefaultMulliganProfile : MulliganProfile
    {
            ...
            Card.CClass ownClass)
        {
            ...
            foreach (Card.Cards card in choices)
            {
                ...
                if(card==Card.Cards.CORE_EX1_506){flag2+=1;}// 鱼人猎潮者 Murloc Tidehunter ID：CORE_EX1_506 
                if(card==Card.Cards.EX1_506){flag2+=1;}// 鱼人猎潮者 Murloc Tidehunter EX1_506 
                if(card==Card.Cards.VAN_EX1_506 ){flag2+=1;}// 鱼人猎潮者 Murloc Tidehunter VAN_EX1_506  
            }
            ...
            foreach (Card.Cards card in choices)
            {
                ...
                // t2
                    ...
                    if(card==Card.Cards.CORE_LOEA10_3//鱼人宝宝 Murloc Tinyfin ID：CORE_LOEA10_3
                    ){ if(!CardsToKeep.Contains(Card.Cards.CORE_LOEA10_3))
                        {
                            Keep(card,"鱼人宝宝");
                        }
                    }
                    if(card==Card.Cards.CORE_EX1_506&&flag1>0//鱼人猎潮者 Murloc Tidehunter ID：CORE_EX1_506 
                    ){ if(!CardsToKeep.Contains(Card.Cards.CORE_EX1_506))
                        {
                            Keep(card,"鱼人猎潮者");
                        }
                    }
                    if(card==Card.Cards.EX1_506&&flag1>0//鱼人猎潮者 Murloc Tidehunter ID：EX1_506 
                    ){ if(!CardsToKeep.Contains(Card.Cards.EX1_506))
                        {
                            Keep(card,"鱼人猎潮者");
                        }
                    }
                    if(card==Card.Cards.VAN_EX1_506&&flag1>0//鱼人猎潮者 Murloc Tidehunter ID：VAN_EX1_506 
                    ){ if(!CardsToKeep.Contains(Card.Cards.VAN_EX1_506))
                        {
                            Keep(card,"鱼人猎潮者");
                        }
                    }
