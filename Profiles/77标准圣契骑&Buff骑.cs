...
#region 莫戈尔·莫戈尔格 BT_019 
        ...
        {
          p.CastSpellsModifiers.AddOrUpdate(Card.Cards.AV_338,new Modifier(650,Card.Cards.BT_019));//坚守桥梁 Hold the Bridge ID：AV_338 
...
#region 正义保护者 CORE_ICC_038
        ...
        {
          p.CastSpellsModifiers.AddOrUpdate(Card.Cards.AV_338,new Modifier(650,Card.Cards.CORE_ICC_038));//坚守桥梁 Hold the Bridge ID：AV_338 
