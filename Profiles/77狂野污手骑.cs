...
#region 水晶学 BOT_909
        ...
        {
        // p.PlayOrderModifiers.AddOrUpdate(Card.Cards.SW_315, new Modifier(9999)); 
           p.CastSpellsModifiers.AddOrUpdate(Card.Cards.BOT_909, new Modifier(-999));
    Bot.Log("水晶学 -999");
        }
...
#region 石牙野猪 CS2_171
        ...
        if(board.HasCardInHand(Card.Cards.VAN_CS2_171)
        )
        {
        // p.PlayOrderModifiers.AddOrUpdate(Card.Cards.SW_315, new Modifier(9999)); 
          p.CastMinionsModifiers.AddOrUpdate(Card.Cards.CS2_171, new Modifier(130));
          p.CastMinionsModifiers.AddOrUpdate(Card.Cards.VAN_CS2_171, new Modifier(130));
          Bot.Log("石牙野猪 130");
        }
